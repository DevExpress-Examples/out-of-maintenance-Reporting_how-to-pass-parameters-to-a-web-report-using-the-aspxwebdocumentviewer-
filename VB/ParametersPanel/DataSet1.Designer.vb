...
Namespace ParametersPanel
	...
	Partial Public Class DataSet1
		...
		Partial Public Class InvoicesDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddInvoicesRow(ByVal OrderDate As System.DateTime, ByVal RequiredDate As System.DateTime, ByVal ProductID As Integer, ByVal Salesperson As String, ByVal ProductName As String) As InvoicesRow
				Dim rowInvoicesRow As InvoicesRow = (CType(Me.NewRow(), InvoicesRow))
				Dim columnValuesArray() As Object = { OrderDate, RequiredDate, ProductID, Salesperson, ProductName}
	...
	End Class
End Namespace
Namespace ParametersPanel.DataSet1TableAdapters
	...
	Partial Public Class InvoicesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        OrderDate, RequiredDate, ProductID, Salesperson, ProductName" & Constants.vbCrLf & "FROM " & "           Invoices"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(1).Connection = Me.Connection
			Me._commandCollection(1).CommandText = "SELECT OrderDate, ProductID, ProductName, RequiredDate, Salesperson FROM Invoices" & " WHERE (OrderDate > ?) AND (RequiredDate < ?)"
			Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("OrderDate", Global.System.Data.OleDb.OleDbType.Date, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "OrderDate", Global.System.Data.DataRowVersion.Current, False, Nothing))
			Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("RequiredDate", Global.System.Data.OleDb.OleDbType.Date, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "RequiredDate", Global.System.Data.DataRowVersion.Current, False, Nothing))
		End Sub
		...
		Public Overridable Function FillBy(ByVal dataTable As DataSet1.InvoicesDataTable, ByVal OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal RequiredDate As Global.System.Nullable(Of Global.System.DateTime)) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			If (OrderDate.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(0).Value = (CDate(OrderDate.Value))
			Else
				Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
			End If
			If (RequiredDate.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(1).Value = (CDate(RequiredDate.Value))
			Else
		...
		Public Overridable Function GetDataBy(ByVal OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal RequiredDate As Global.System.Nullable(Of Global.System.DateTime)) As DataSet1.InvoicesDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(1)
			If (OrderDate.HasValue = True) Then
				Me.Adapter.SelectCommand.Parameters(0).Value = (CDate(OrderDate.Value))
			Else
